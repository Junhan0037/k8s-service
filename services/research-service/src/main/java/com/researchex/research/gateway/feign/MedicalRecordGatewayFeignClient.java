 ...
 * 연결 정보와 헤더 전파는 {@link MedicalRecordGatewayFeignConfiguration} 에서 관리한다.
 */
@FeignClient(
...
public interface MedicalRecordGatewayFeignClient {

  @GetMapping("/internal/patients/{patientId}/records/latest")
  MedicalRecordSummaryResponse fetchLatestRecord(@PathVariable("patientId") String patientId);
}

...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBusinessException(BusinessException ex) {
        ...
        ErrorResponse body = ErrorResponse.of(code, currentTraceId(), Map.of("reason", ex.getMessage()));
    ...
    public ResponseEntity<Object> handleConstraintViolation(ConstraintViolationException ex) {
        ...
        ErrorResponse body = ErrorResponse.of(
                CommonErrorCode.VALIDATION_ERROR, currentTraceId(), details);
    ...
    protected ResponseEntity<Object> handleMissingServletRequestPart(
            ...
            WebRequest request) {
        ErrorResponse body = ErrorResponse.of(
                CommonErrorCode.VALIDATION_ERROR, currentTraceId(), Map.of("partName", ex.getRequestPartName()));
        return ResponseEntity.status(CommonErrorCode.VALIDATION_ERROR.getHttpStatus()).body(body);
    }

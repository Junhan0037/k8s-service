...
public class HttpLoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        ContentCachingRequestWrapper requestWrapper = new ContentCachingRequestWrapper(request, loggingProperties.getMaxPayloadLength());
    ...
    private void logExchange(ContentCachingRequestWrapper request, ContentCachingResponseWrapper response, long duration) {
        try {
            ...
            String requestBody = loggingProperties.isIncludeRequestBody()
                    ? extractBody(request.getContentAsByteArray())
                    : "";
            String responseBody = loggingProperties.isIncludeResponseBody()
